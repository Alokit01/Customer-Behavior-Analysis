...
-- Do subscribed customers spend more? Compare both average spend and total revenue between
...
SELECT item_purchased,
       ROUND(100 * SUM(CASE WHEN discount_applied = 'Yes' THEN 1 ELSE 0 END) / COUNT(*),
           2) AS discount_rate
FROM customer
GROUP BY item_purchased
...
FROM item_counts
WHERE item_rank <= 3;
-- Are customers who are repeat buyers (more than 5 previous purchases) more likely to 
-- subscribe?
SELECT subscription_status,
